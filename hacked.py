...
\033[1;94mFACEBOOK  RJ RAJU RAZZ
                  
\033[1;92mFB PAGE   RJ RAJU RAZZ
...
╔══──────────────────────────╗─══╗
║ OWNER 💓💓💓RJ-RAJU-RAZZ           ║║
║  GITHUB 💝💝💝 RJRAJURAZZ(RJ)   ║ ║
║ FACEBOOK 💝💝💝RJ-HACKER ║ ║
║  ENJOY 💝💝💝Pak Cloning                ║ ║
║   Note 💝💝💝You Can Do Anything║ ║
╚══──────────────────────────╝─══╝
...
╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
                         ...
                         DON'T COPY MY SCRIPT
                                      RED-MAFIA          
                                        TNX(RK)
╔══──────────────────────────╗─══╗
║OWNER 💓💓💓RJ RAJU RAZZ (RJ)                              ║
║  GITHUB 💝💝💝 RJRAJURAZZ                             ║
║ FACEBOOK 💝💝💝RJ RAJU RAZZ                 ║
║  ENJOY 💝💝💝Pak Cloning                             ║
║   Note 💝💝💝You Are a Genius 😈           ║
╚══──────────────────────────╝─══╝
"""
print("""
Owner: RJ RAJU RAZZ(RJ)
